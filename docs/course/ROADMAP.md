...
Кейс: мониторинг качества данных в БД, обнаружение аномалий и объяснение сигналов.

[Канбан-доска](https://github.com/users/aleksandr-novikov/projects/2/views/2) · [Все задачи](https://github.com/aleksandr-novikov/ai-integration-development/issues) · [Этапы](https://github.com/aleksandr-novikov/ai-integration-development/milestones)

## Основа и граница работ

Проект основан на [https://github.com/aleksandr-novikov/db-monitoring](https://github.com/aleksandr-novikov/db-monitoring), коммит `1a869e4bb24c2b0e238249e04ca46f97534a2a1f` от 11 июня 2026.
...
5. **Защита (В17–В18).** Отчёт 5–7 страниц, презентация 10–15 слайдов, 5 минут выступления и 2 минуты вопросов.
...
| Участник | GitHub | Начальный фокус для согласования |
|---|---|---|
...
Это предложение по организации, а не утверждение о выполненном вкладе. Конкретные исполнители назначаются при взятии задач.
